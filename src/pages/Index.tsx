...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-green-100 dark:from-green-950 dark:via-gray-900 dark:to-green-900 relative overflow-hidden">
      {/* Enhanced Decorative background shapes with better visibility */}
      <div className="absolute inset-0 pointer-events-none">
        {/* Large primary blobs */}
        <div className="absolute top-10 left-10 w-72 h-64 bg-green-400/30 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute top-32 right-20 w-96 h-80 bg-green-500/25 rounded-full blur-3xl transform rotate-12 animate-bounce-gentle"></div>
        <div className="absolute top-64 left-1/4 w-48 h-56 bg-green-600/35 rounded-full blur-xl transform -rotate-45"></div>
        <div className="absolute top-80 right-1/3 w-80 h-72 bg-green-400/30 rounded-full blur-2xl transform rotate-45"></div>
        
        {/* Medium accent blobs */}
        <div className="absolute bottom-32 left-20 w-64 h-88 bg-green-500/30 rounded-full blur-xl transform -rotate-12"></div>
        <div className="absolute bottom-48 right-16 w-56 h-64 bg-green-600/25 rounded-full blur-lg transform rotate-30"></div>
        <div className="absolute bottom-80 left-1/2 w-88 h-96 bg-green-400/20 rounded-full blur-3xl transform -rotate-30"></div>
        <div className="absolute top-1/2 left-8 w-40 h-48 bg-green-700/35 rounded-full blur-md transform rotate-60"></div>
        
        {/* Small decorative blobs */}
        <div className="absolute top-1/3 right-8 w-60 h-72 bg-green-500/25 rounded-full blur-xl transform -rotate-45"></div>
        <div className="absolute top-2/3 left-1/3 w-96 h-80 bg-green-300/20 rounded-full blur-3xl transform rotate-15"></div>
        <div className="absolute top-1/4 left-2/3 w-52 h-64 bg-green-600/30 rounded-full blur-2xl transform -rotate-60"></div>
        
        {/* Extra organic shapes */}
        <div className="absolute top-96 left-12 w-32 h-40 bg-green-700/40 rounded-full blur-lg transform rotate-90"></div>
        <div className="absolute bottom-64 right-32 w-44 h-56 bg-green-500/35 rounded-full blur-xl transform -rotate-30"></div>
        <div className="absolute top-48 left-3/4 w-68 h-80 bg-green-400/25 rounded-full blur-2xl transform rotate-75"></div>
        <div className="absolute bottom-96 left-1/4 w-48 h-56 bg-green-600/30 rounded-full blur-xl transform -rotate-15"></div>
        
        {/* Additional floating blobs */}
        <div className="absolute top-2/4 right-1/4 w-76 h-88 bg-green-500/20 rounded-full blur-3xl transform rotate-45"></div>
        <div className="absolute bottom-1/3 left-2/3 w-56 h-68 bg-green-700/25 rounded-full blur-2xl transform -rotate-75"></div>
        
        {/* More varied shapes */}
        <div className="absolute top-20 left-1/2 w-84 h-72 bg-green-400/15 rounded-full blur-3xl transform rotate-30"></div>
        <div className="absolute bottom-20 right-1/2 w-72 h-64 bg-green-600/20 rounded-full blur-2xl transform -rotate-45"></div>
      </div>
      ...
      <div className="relative z-10 w-full overflow-x-hidden">
        ...
        <section className="relative overflow-hidden w-full">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-green-950 dark:via-blue-950 dark:to-purple-950 animate-gradient-shift opacity-80"></div>
